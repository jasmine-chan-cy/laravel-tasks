    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'database' => env('AZURE_MYSQL_DBNAME', 'msdocs-laravel-mysql-392-database'),
            'username' => env('AZURE_MYSQL_USERNAME', 'mdemlwmclk'),
            'password' => env('AZURE_MYSQL_PASSWORD', 'zGQRF$1H6AdjXebx'),
